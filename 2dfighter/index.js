...
const background = new Sprite({
    ...
    imageSrc: './2dfighter/images/background/background.png'
})
...
const player = new Fighter({
    ...
    imageSrc: './2dfighter/images/player/Idleright.png',
    framesMax: 10,
    scale: 2.5,
    offset: {
        x: 120,
    ...
    sprites: {
        idleleft: {
            imageSrc: './2dfighter/images/player/Idleleft.png',
            framesMax: 10,
            framesHold: 5,
        },
        idleright: {
        ...
        runleft: {
            imageSrc: './2dfighter/images/player/Runleft.png',
            framesMax: 8,
            framesHold: 6,
        },
        runright: {
            imageSrc: './2dfighter/images/player/Runright.png',
            framesMax: 8,
            framesHold: 6,
        },
        jumpleft: {
            imageSrc: './2dfighter/images/player/Jumpleft.png',
            framesMax: 3,
            framesHold: 5,
        },
        jumpright: {
            imageSrc: './2dfighter/images/player/Jumpright.png',
            framesMax: 3,
            framesHold: 5,
        },
        fallleft: {
            imageSrc: './2dfighter/images/player/Fallleft.png',
            framesMax: 3,
            framesHold: 5,
        },
        fallright: {
            imageSrc: './2dfighter/images/player/Fallright.png',
            framesMax: 3,
            framesHold: 5,
        },
        attackleft: {
            imageSrc: './2dfighter/images/player/Attackleft.png',
            framesMax: 7,
            framesHold: 5,
        },
        attackright: {
            imageSrc: './2dfighter/images/player/Attackright.png',
            framesMax: 7,
            framesHold: 5,
        },
        hitleft: {
            imageSrc: './2dfighter/images/player/Take Hitleft.png',
            framesMax: 3,
            framesHold: 8,
        },
        hitright: {
            imageSrc: './2dfighter/images/player/Take Hitright.png',
            framesMax: 3,
            framesHold: 8,
        },
        death: {
            imageSrc: './2dfighter/images/player/Death.png',
            framesMax: 11,
            framesHold: 6,
        },
    }
...
const enemy = new Fighter({
    ...
    imageSrc: './2dfighter/images/enemy/Idleright.png',
    framesMax: 8,
    scale: 2.5,
    offset: {
        x: 160,
    ...
    sprites: {
        idleleft: {
            imageSrc: './2dfighter/images/enemy/Idleleft.png',
            framesMax: 8,
            framesHold: 6,
        },
        idleright: {
        ...
        runleft: {
            imageSrc: './2dfighter/images/enemy/Runleft.png',
            framesMax: 8,
            framesHold: 6,
        },
        runright: {
            imageSrc: './2dfighter/images/enemy/Runright.png',
            framesMax: 8,
            framesHold: 6,
        },
        jumpleft: {
            imageSrc: './2dfighter/images/enemy/Jumpleft.png',
            framesMax: 2,
            framesHold: 5,
        },
        jumpright: {
            imageSrc: './2dfighter/images/enemy/Jumpright.png',
            framesMax: 2,
            framesHold: 5,
        },
        fallleft: {
            imageSrc: './2dfighter/images/enemy/Fallleft.png',
            framesMax: 2,
            framesHold: 5,
        },
        fallright: {
            imageSrc: './2dfighter/images/enemy/Fallright.png',
            framesMax: 2,
            framesHold: 5,
        },
        attackleft: {
            imageSrc: './2dfighter/images/enemy/Attackleft.png',
            framesMax: 4,
            framesHold: 8,
        },
        attackright: {
            imageSrc: './2dfighter/images/enemy/Attackright.png',
            framesMax: 4,
            framesHold: 8,
        },
        hitleft: {
            imageSrc: './2dfighter/images/enemy/Take Hitleft.png',
            framesMax: 4,
            framesHold: 8,
        },
        hitright: {
            imageSrc: './2dfighter/images/enemy/Take Hitright.png',
            framesMax: 4,
            framesHold: 8,
        },
        death: {
            imageSrc: './2dfighter/images/enemy/Death.png',
            framesMax: 6,
            framesHold: 10,
        },
    }
